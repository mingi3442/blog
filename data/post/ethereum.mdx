...
canonicalUrl: 'https://min71.dev/posts/ethereum'
---
...
**이더리움에서 트리는 [Merkle Patricia Trie](https://min71.dev/posts/cryptography-data-structure-for-verification#merkle-patricia-trie-mpt)를 이용하며 모든 block의 header에는 `State Trie`, `Transaction Trie`, `Recipts Trie`의 root값이 존재합니다.**
